...
export default function Home() {
  return (
    <>
      <img src="/yeet21.png" alt="UAGPMC Logo" height="100" />
      ...
      <p>
        ...
        a long hiatus from the game. If you're interested in joining us, please
        join our Discord server below, grab the Arma 3 role, and say hello!
      </p>
      <p>
        <a className="discordLink" href="https://unnamed.group/discord">
          Discord
        </a>
      </p>
      <footer>
        <p>
          A project by <a href="https://unnamed.group">Unnamed Group</a>
        </p>
      </footer>
    </>
  );
